...
public class CsvImportParserTests
{
    ...
    public void Parse_ReturnsRows_WithNormalizedHeadersAndRowNumbers()
    {
        const string csv = """
            ...
            Lobby,RTSP,Generic,192.168.1.11,81,8554,9000,user,pass,RTSP,"rtsp://lobby/main,sub",Hall
            """;
    ...
    public void Parse_SupportsQuotedFields_AndCommaInsideQuotedField()
    {
        const string csv = """
            Name,Brand,Model,IP Address,HTTP Port,RTSP Port,SDK Port,Username,Password,Connection Type,RTSP URL,Location
            "Camera, A",RTSP,Model A,10.0.0.1,80,554,8000,admin,1234,RTSP,"rtsp://10.0.0.1/stream,1","Room, A"
            """;
    ...
    {
        var csv = "Name,Brand,Model,IP Address,HTTP Port,RTSP Port,SDK Port,Username,Password,Connection Type,RTSP URL,Location\r\n" +
                  "\u6E2C\u8A66\u651D\u5F71\u6A5F,Hikvision,\u578B\u865FA,192.168.10.1,80,554,8000,admin,1234,HikvisionISAPI,rtsp://test/1,\u5927\u5EF3";
    ...
    {
        var csv = "Name,Brand,Model,IP Address,HTTP Port,RTSP Port,SDK Port,Username,Password,Connection Type,RTSP URL,Location\r\n" +
                  "\u6E2C\u8A66BOM,Hikvision,\u578B\u865FB,192.168.10.2,80,554,8000,admin,1234,HikvisionISAPI,rtsp://test/2,\u5165\u53E3";
    ...
    {
        var csv = "Name,Brand,Model,IP Address,HTTP Port,RTSP Port,SDK Port,Username,Password,Connection Type,RTSP URL,Location\r\n" +
                  "\u7121BOM\u6E2C\u8A66,Hikvision,\u578B\u865FC,192.168.10.3,80,554,8000,admin,1234,HikvisionISAPI,rtsp://test/3,\u5009\u5EAB";
    ...
    public void Parse_SupportsBig5Encoding()
    {
        ...
        var csv = "Name,Brand,Model,IP Address,HTTP Port,RTSP Port,SDK Port,Username,Password,Connection Type,RTSP URL,Location\r\n" +
                  "\u5927\u9580\u651D\u5F71\u6A5F,Hikvision,\u578B\u865FD,192.168.10.4,80,554,8000,admin,1234,HikvisionISAPI,rtsp://test/4,\u5927\u9580";
